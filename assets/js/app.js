    ...
    var uiLoader = function($mode) {
        ...
        if ($mode === 'show') {
            ...
            if ($lpageLoader.length) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/Home/GetModuleAccess',
                    success: function (data) {
                        if (data.length <= 0)
                        {
                            bootbox.alert({
                                size: "small",
                                title: "You don't have any Access.",
                                message: "Contact our system Administrator for assistance.",
